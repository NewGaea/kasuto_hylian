...
Unlike [[kasuto-roman|Kasutan Romanization]], this includes the **[six letters](archive/vinculum/six_new_letters.md)** which [[kasuto|Kasuto]] announced on [[archival/vinculum/index|the Vinculum forums]]. However, Springerian Romanization is an adaptation of Kasutan Romanization with the following changes:
...
| **<span class="hylian_kas">D</span><br>dhënte** | **dh, D** | **dh, D** |
