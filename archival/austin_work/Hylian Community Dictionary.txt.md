...
A
	adakae	noun	toe	/derived from "aikwe daia kame", lit. "finger of foot"/
	aikwe	noun	finger
	akonde	noun	sky	
	aku	pronoun	there
	alu	pronoun	here
...
B
	...
	batyahe	noun	valley
	b�u	pronoun	me (object case)
	b��koge	noun	earth, ground, dirt
...
D
	daminazh�folkag	verb	to roll around on the grass with a pet
	d�na	adjective	small
	d�nal'usheoke	noun	male undergarments
	d�nan'usheoke	noun	lingerie	/alternative form proposed by Venus, interpreting the -il- and -in- suffixes to imply a natural gender, or in her words: "because underwear aren't people;" Austin disagrees about this implication, and prefers the other entry, though he maintains this form for historical purposes/
	d�nush�okine	noun	lingerie
E
...
H
	...
	hiose	noun	child
	hi�sile	noun	boy, son
	hi�sine	noun	girl, daughter
	hizaze	noun	ear
	hrai�te	noun	praise, glory, reward	/unlikely word, no other evidence of _hr_ exists - propose _hai�te_ or _rai�te_ instead/
I
	ig�mobondozisag	verb	to set fire to something important
...
*	ipa'a	adjective	married, by marriage	/added by Austin, based on Venus's _ipae_ and _ipa_ prefix)/
	...
	isue	noun	nose
	itoke	noun	cousin
	it�kile	noun	male cousin
	it�kine	noun	female cousin
J
	...
	jhel�kea	adjective	lucky, having good fortune, prone to success
...
K
	...
	ke�se	noun	bat, keese
	k�wle	noun	fish	/alternatives: kaule, k�ule/
	ktaniyuhrozag	verb	to exasperate, to exhaust, to use up all energy	/unlikely, no evidence for _kt_ or _hr_ exists, structure does not fit Kasuto's canonical forms; propose _k�tanyurozag_ instead/
...
N
	...
	nap�tile	noun	grandson
	nap�tine	noun	granddaughter
...
-	polute	noun	chicken, cucco	/conflicts with earlier kukoe, which fits the theme of keeping Hylian names presented in the games as close as possible to their original forms; may be glossed to a different type of bird/
	pot�ra	adjective	strong, powerful
	pot�re	noun	strength, power
	pro	preposition	than
	protojh�k	conjunction	because
R
	reaketag	noun	to fight
	reakete	noun	battle, fight, skirmish
	reathoa	adjective	angry
	rok�lzisag	verb	to light up, to illuminate
	rok�lzise	noun	light (physical)
	rope	noun	snake, serpent
S
	se	noun	chest, torso
	s�k	conjunction	but
	serise	noun	hair	/normally used in the plural seris�n, similar to french cheveux/
	sesolag	verb	to rain, to snow
	sesole	noun	rain
	sh�mopjhoke	noun	sunglasses, shaded eyewear	/likely not used in Hyrule/
	...
	s�file	noun	grandfather
	s�fine	noun	grandmother
...
T
	...
	tr�owag	verb	to trust
	tr�owe	noun	trust, confidence
U
	upag	verb	to pray
	upe	noun	prayer
	ushe	noun	groin, crotch, sexual organs
	usheoke	noun	undergarments, underclothes, underwear
	ush�okile	noun	men's undergarments
	ush�okine	noun	women's undergarments
V
-	vere	noun	???	/proposed as "truth" which is veuarde/
	v�u	pronoun	you all (object case)
