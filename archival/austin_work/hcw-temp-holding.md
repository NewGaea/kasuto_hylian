...
+ [x] **bëu** _pronoun_ 1. me 1. part of a proposed set of _object role_ pronouns, equivalent to canonical _ab bagu_; originally proposed as _më -> mëu -> bëu_ ([[qbri|QBri]])
...
+ [x] **Come** _noun_ 1. thing 1. native form of _obJekte_ ([[qbri|QBri]])
+ [x] **Cuke** _noun_ 1. chuka 1. a unit of length equal to 4 _dënletën_, or 9 U.S. Customary feet ([[pata-hikari|Pata Hikari]])
...
+ [x] **dëna** _adjective, prefix_ 1. small ([[venus|Venus]]) 2. half, less than fully, only sharing one parent 2. suggested for use in kinship terms equivalent to English _half-sister_ ([[venus|Venus]])
...
## H
+ [x] **hag** _verb, pro-verb_ 1. to exist 1. from Spanish _hag_ (to exist), used in copular constructions like “there is, there are, etc.” ([[qbri|QBri]])
+ [x] **hakwa** _adjective_ 1. helpless ([[qbri|QBri]])
+ [x] **hakwag** _verb_ 1. to be helpless ([[qbri|QBri]])
+ [x] **handag** _verb_ 1. to get, to receive ([[qbri|QBri]])
+ [x] **hai'ag** _verb_ 1. to run ([[qbri|QBri]])
+ [x] **hedag** _verb_ 1. to make, to create 1. conflicts with canonical _kriaSag_ (to make, to create) ([[contributors/tushen|Tushen]])
+ [x] **hetobe** _noun_ 1. body 1. from Old High German _boteh_ (corpse) ([[venus|Venus]])
+ [x] **hetobokag** _verb_ 1. to clothe, to dress ([[venus|Venus]])
+ [x] **hetoboke** _noun_ 1. clothing, garment ([[venus|Venus]])
+ [x] **hevondre** _noun_ 1. Spiritsday 1. fifth day of the Hylian week; from proposed _hevone_ (spirit) and canonical _tiudre_ (daytime) ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[kasuto|Kasuto]], [[contributors/arrow|Arrow]]?)
+ [x] **hevone** _noun_ 1. elemental spirit ([[pata-hikari|Pata Hikari]])
+ [x] **hevónpita** _adjective_ 1. northwest 1. see _hevónpite_ ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[contributors/auric_trinity|Auric Trinity]])
+ [x] **hevónpite** _noun_ 1. northwest 1. from proposed _hevone + pite_ "spirit gate" ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[contributors/auric_trinity|Auric Trinity]])
...
+ [x] **hiose** _noun_ 1. child 1. from Greek _hyios_ (son) ([[venus|Venus]])
+ [x] **hiósile** _noun_ 1. son, boy ([[venus|Venus]])
+ [x] **hiósine** _noun_ 1. daughter, girl ([[venus|Venus]])
+ [x] **hiramiCe** _noun_ 1. hour 1. means “(the) first division“ with first meaning greatest or largest; from canonical _hira_ (one), originally proposed as _hiramiche_ ([[venus|Venus]], [[kasuto|Kasuto]], [[contributors/arrow|Arrow]])
+ [x] **hirmoka** _adjective_ 1. again 1. from canonical _hire + moka_, (one more) ([[qbri|QBri]])
...
## I
+ [x] **igámobondozisag** _verb_ 1. to light something important on fire ([[emekthian]])
+ [x] **ike** _noun, suffix?_ 1. era, period of time 1. used as a suffix in several proposed words referring to seasons, possibly including _kraitike_ (season), though this may merely be a suffix form of _kraitike_ ([[venus|Venus]], [[contributors/arrow|Arrow]]?)
+ [x] **ilidane** _noun_ 1. storm ([[slacker|Slacker]])
...
+ [x] **ipa** _adjective, prefix_ 1. by marriage, in-law, step- 1. suggested to refer to relations through marriage like English _stepfather_ “suppose it could also refer to inlaws” ([[venus|Venus]])
+ [x] **ipae** _noun_ 1. spouse 1. from Hittite _sipant-_ (spouse) ([[venus|Venus]])
+ [x] **ipáile** _noun_ 1. husband ([[venus|Venus]])
+ [x] **ipáine** _noun_ 1. wife ([[venus|Venus]])
+ [x] **ire** _noun_ 1. temperature ([[venus|Venus]], [[contributors/arrow|Arrow]]?)
+ [x] **isue** _noun_ 1. nose ([[venus|Venus]])
+ [x] **itag** _verb_ 1. to hurt, to harm 1. from Japanese _<ruby>痛い<rt>いたい</rt></ruby>_ (painful, sore) ([[qbri|QBri]])
+ [x] **ite** _noun_ 1. injury, wound 1. from Japanese _<ruby>痛い<rt>いたい</rt></ruby>_ (painful, sore) ([[qbri|QBri]])
...
+ [x] **izag** _verb_ 1. to ease 1. from English _ease,_ phonetic ([[qbri|QBri]])
...
+ [ ] **joStag** _verb_ 1. to occur, to happen 1. synonym of _pansag_, used in more casual speech ([[qbri|QBri]])

## JH
+ [x] **Ja** _expression_ 1. Yeah, Sure, Of course ([[qbri|QBri]])
+ [x] **Je** _expression_ 1. Well, Hmm ([[qbri|QBri]])
+ [x] **Jeka** _adjective_ 1. cool, sweet, awesome ([[qbri|QBri]])
+ [x] **Jeluke** _noun_ 1. luck ([[k-chan|K-Chan]], [[venus|Venus]])
+ [x] **Jelúkea** _adjective_ 1. lucky ([[k-chan|K-Chan]], [[venus|Venus]])
+ [x] **Ji** _interjection, expression_ 1. yeah, right, pfft, pssh 1. an expression used to  blow someone off, simultaneously acknowledging that one has heard what is being said and chooses to disregard or dismiss it ([[venus|Venus]])
+ [x] **Jiag** _verb_ 1. to dismiss, to curse, to speak ill of 1. from proposed _Ji_ ([[qbri|QBri]])
...
## K
+ [x] **kacae** _noun_ 1. door 1. from _kamitsae_ (path), originally proposed as _katsae_ ([[kasuto|Kasuto]], [[qbri|QBri]])
+ [x] **kafulag** _verb_ 1. to defeat, to beat ([[qbri|QBri]])
+ [x] **kaJe** _noun_ 1. teenager, adolescent, youth ([[qbri|QBri]])
+ [x] **káJile** _noun_ 1. guy, bro, dude, young man ([[qbri|QBri]])
+ [x] **káJiloi** _noun, expression_ 1. dude, bro ([[qbri|QBri]])
+ [x] **káJine** _noun_ 1. girl, gal, cutie, young lady ([[qbri|QBri]])
+ [x] **káJinoi** _noun, expression_ 1. chick, babe ([[qbri|QBri]])
+ [x] **kame** _noun_ 1. foot 1. back-formation from proposed _kamoke_ (boot) ([[k-chan|K-Chan]], [[venus|Venus]])
+ [x] **kamoke** _noun_ 1. boot, pair of boots ([[k-chan|K-Chan]])
+ [x] **kariuse** _noun_ 1. lightning ([[venus|Venus]], [[contributors/arrow|Arrow]]?)
+ [x] **karüse** _noun_ 1. electricity, lightning? ([[venus|Venus]], [[contributors/arrow|Arrow]]?)
+ [x] **katene** _noun_ 1. sword, broadsword 1. from Japanese (<em><ruby>刀<rt>かたな</rt></ruby></em>) (sword) ([[pata-hikari|Pata Hikari]])
+ [ ] **katene lasta** _proper noun_ 1. Master Sword (_[[nintendo|Nintendo]]_, [[pata-hikari|Pata Hikari]])
+ [x] **kaista** _adjective_ 1. cold ([[venus|Venus]], [[contributors/arrow|Arrow]]?)
+ [x] **kaistike** _noun_ 1. winter 1. literally means “cold time” from proposed _kaista + ike_ (cold era) ([[venus|Venus]], [[contributors/arrow|Arrow]]?)
+ [x] **kaistire** _noun_ 1. ice 1. compound of proposed _kaista + ire_ (cold temperature), or a mirroring of the structure of canonical _faeuire_ (fire) onto _kaista_ ([[venus|Venus]], [[contributors/arrow|Arrow]]?)
+ [ ] **kaule** _noun_ 1. fish 1. alternative to _këwle_ ([[venus|Venus]])
+ [x] **keese** _noun_ 1. bat 1. so named for the [[enemy-list|baddie]] (_[[nintendo|Nintendo]]_; [[k-chan|K-Chan]], [[venus|Venus]]) 2. keese (Nintendo, BBB)
...
+ [x] **këuma** _adjective_ 1. bad, wrong ([[qbri|QBri]])
+ [x] **këume** _noun_ 1. trouble, evil ([[qbri|QBri]])
+ [x] **këwle** _noun_ 1. fish ([[oluademi-wolfwood|Oluademi Wolfwood]], [[venus|Venus]])
+ [ ] **\*kiane** _noun_ 1. bike, bicycle ([[qbri|QBri]])
+ [x] **kiumag** _verb_ 1. to taste 1. inspired by canonical _koemag_ (to eat) ([[qbri|QBri]])
+ [x] **kiume** _noun_ 1. taste, flavour 1. inspired by canonical _koeme_ (food) ([[qbri|QBri]])
+ [ ] **kok** _adverb_ 1. no, not 1. conflicts with canonical _naz_ ([[contributors/tushen|Tushen]])
+ [x] **koi'ag** _verb_ 1. to open ([[qbri|QBri]])
+ [x] **kraktag** _verb_ 1. to break 1. from English _crack_ ([[qbri|QBri]])
+ [x] **kraitike** _noun_ 1. season ([[venus|Venus]], [[contributors/arrow|Arrow]]?)
+ [ ] **-krohi** _honorific, suffix_ 1. sir, knight, guard 1. used to indicate a member of the Hyrulean Royal Guard
+ [x] **krozag** _verb_ 1. to kill ([[qbri|QBri]])
+ [ ] **ktaniyuhrozag** _verb_ 1. to exasperate ([[Emekthian]])
+ [x] **kukoe** _noun_ 1. chicken 1. so named for the [[enemy-list|critter]] (_[[nintendo|Nintendo]]_; [[k-chan|K-Chan]], [[venus|Venus]]) 2. cucco (_[[nintendo|Nintendo]]_, [[bbb|BBB]])
+ [ ] **kuraJe** _noun_ 1. courage 1. possibly tongue-in-cheek ([[venus|Venus]])
+ [x] **kwatau** _pronoun_ 1. whichever ([[qbri|QBri]])
+ [ ] **kwanto** _pronoun_ 1. how many, how much ([[qbri|QBri]])

## KH

## L
+ [x] **la** _adjective, prefix_ 1. masculine object prefix ([[venus|Venus]])
+ [x] **lasta** _adjective_ 1. master, ruler, best ([[pata-hikari|Pata Hikari]])
+ [x] **le** _noun, prefix_ 1. male, masculine ([[venus|Venus]])
+ [x] **lete** _noun_ 2. leto 2. a unit of length equal to 21 _Cukën_, or 189 U.S. Customary feet; _added:_ the _lete_ may be the standard Hylian unit of length for surveying land and measuring property boundaries ([[pata-hikari|Pata Hikari]])
+ [x] **linkre** (as _lincre_) _noun_ 1. courage 1. the root of the Hylian name Linc \[sic] ([[pata-hikari|Pata Hikari]])
...
+ [x] **luberag** _verb_ 1. to please ([[venus|Venus]])
+ [x] **ludag** _verb_ 1. to play an instrument, to perform music ([[qbri|QBri]])
+ [x] **ludre** _noun_ 1. Shadowsday 1. fourth day of the Hylian week; from proposed _lune_ (shadow) and canonical _tiudre_ (daytime) ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[kasuto|Kasuto]], [[contributors/arrow|Arrow]]?)
+ [x] **lune** _noun_ 1. elemental shadow, elemental darkness ([[pata-hikari|Pata Hikari]])
+ [x] **lúnpita** _adjective_ 1. western 1. see _lúnpite_ ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[contributors/auric_trinity|Auric Trinity]])
+ [x] **lúnpite** _noun_ 1. west 1. from proposed _lune + pite_ "shadow gate," referring to the shadows of twilight and sunset; _added:_ this is a logical addition to the elemental compass idea which Auric seems to have simply overlooked ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[contributors/auric_trinity|Auric Trinity]])
+ [x] **lupe** _noun_ 1. dog 1. from Latin _lupis_ \[sic] (wolf), conflicts with canonical _kaiane_ (dog) ([[pata-hikari|Pata Hikari]])
+ [ ] **luSeoke** _noun_ 1. masculine undergarment ([[venus|Venus]])

## M
+ [x] **ma** _adjective, prefix_ 1. big ([[venus|Venus]]) 2. great, senior to, older than 2. suggested for use in kinship terms equivalent to English _great-grandfather_ ([[venus|Venus]])
+ [x] **macag** _noun_ 1. to wait 1. _presumed_ from Japanese _<ruby>待<rt>ま</rt></ruby>って_ (wait), originally proposed as _matsag_ ([[qbri|QBri]])
+ [x] **magzag** _verb_ 1. to kiss ([[venus|Venus]])
+ [x] **magze** _noun_ 1. kiss ([[venus|Venus]])
+ [x] **mahag** _verb_ 1. to promise ([[qbri|QBri]])
+ [x] **mahe** _noun_ 1. promise ([[qbri|QBri]])
...
+ [x] **malanmale** _noun_ 1. million, one million 1. derived from _malan malën_ ([[venus|Venus]])
...
+ [x] **malete** _noun_ 1. maleto, mile 1. a unit of length equal to 3 _terën_, or 1.18125 U.S. Customary miles; _added:_ the _malete_ is the standard measure of traveling distance in Hyrule
...
+ [x] **mamaonkve** _noun_ 1. Great Flood 1. third month of the Hylian year, from proposed _ma_ (big), reduplicated, and canonical _onkve_ (water) ([[kasuto|Kasuto]], [[venus|Venus]], [[contributors/arrow|Arrow]]?)
...
+ [x] **masoke** _noun_ 1. tunic 1. literally “big shirt” ([[k-chan|K-Chan]])
+ [x] **matre** _noun_ 1. mouse 2. matra 2. a unit of length equal to 3 U.S. Customary inches 1, 2. ([[pata-hikari|Pata Hikari]])
+ [x] **mavlise** _noun_ 1. forest ([[venus|Venus]])
+ [ ] **mavlise kokirna** _proper noun_ 1. Kokiri Forest 1. replaces proposed _mavlise kokiri_ (_[[nintendo|Nintendo]]_, [[bbb|BBB]])
+ [x] **mejag** _verb_ 1. to resemble, to look like 1. from Spanish _asemejarse_ (to resemble) ([[venus|Venus]])
...
+ [x] **merkle** _noun_ 1. monument, marker, headstone 1. from a local business owner's name ([[contributors/auric_trinity|Auric Trinity]])
+ [x] **mevine** _noun_ 1. master (proficiency), expert 1. from "_mevyn_ (sp?)," probably meant to be Hebrew <em><ruby>מֵבִין<rt>may-veen</rt></ruby></em> (one who understands, teacher, expert) ([[contributors/auric_trinity|Auric Trinity]])
+ [x] **mia** _adjective_ 1. red
+ [ ] **miafire** _noun_ 1. ruby 1. from proposed _mia_ (red) and canonical _siafire_ (sapphire) ([[contributors/stella_snile]])
+ [x] **miare** _noun_ 1. vision ([[venus|Venus]])
+ [x] **mihia** _adjective_ 1. orange 1. literally “red-yellow” ([[k-chan|K-Chan]])
+ [x] **mikare** _noun_ 1. hero ([[qbri|QBri]])
+ [x] **mike** _noun_ 1. grass ([[qbri|QBri]])
...
+ [x] **misëte** _noun_ 1. breakfast 1. alternate (shorter) form of _minazisëte_ ([[oluademi-wolfwood|Oluademi Wolfwood]], [[venus|Venus]])
+ [ ] **moblne** _noun_ 1. moblin (_[[nintendo|Nintendo]]_, [[pata-hikari|Pata Hikari]])
+ [x] **mokok** _adverb_ 1. much, very 1. from canonical _moka_ (much, many) ([[kasuto|Kasuto]], [[qbri|QBri]])
+ [ ] **moldrme** _noun_ 1. moldorm (_[[nintendo|Nintendo]]_, [[pata-hikari|Pata Hikari]])
+ [x] **molordre** _noun_ 1. Forestday 1. first day of the Hylian week; from proposed _molorne_ (forest element) and canonical _tiudre_ (daytime) ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[kasuto|Kasuto]], [[contributors/arrow|Arrow]]?)
+ [x] **molorne** _noun_ 1. elemental forest ([[pata-hikari|Pata Hikari]])
+ [x] **molórnpita** _adjective_ 1. southeast 1. see _molórnpite_ ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[contributors/auric_trinity|Auric Trinity]])
+ [x] **molórnpite** _noun_ 1. southeast 1. from proposed _molorne + pite_ "forest gate" ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[contributors/auric_trinity|Auric Trinity]])
+ [x] **monte** _noun_ 1. word 1. inspired by French _Montclair_ (clear mountain) . and _mot_ (word) ([[venus|Venus]])
+ [x] **moskag** _noun_ 1. to fly 1. from Spanish _mosca_ (insect) ([[k-chan|K-Chan]], [[venus|Venus]])
+ [x] **moa** _conjunction_ 1. also, in addition ([[qbri|QBri]])
+ [x] **moi’ag** _verb_ 1. to hear, to listen ([[venus|Venus]])
+ [x] **munTaize** _noun_ 1. mouth ([[venus|Venus]])
+ [ ] **myire** _noun_ 1. ant 1. from Swedish _myra_ (ant) ([[contributors/stella_snile]])

## N
+ [x] **na** _adjective, prefix_ 1. feminine object prefix ([[venus|Venus]])
+ [x] **name** _noun_ 1. hand 1. backformed from _namoke_ (glove) ([[venus|Venus]])
+ [x] **namoke** _noun_ 1. glove, pair of gloves ([[k-chan|K-Chan]])
+ [x] **nanka** _adjective_ 1. any ([[qbri|QBri]])
+ [x] **nanke** _noun_ 1. anything ([[qbri|QBri]])
+ [x] **napete** _noun_ 1. grandchild 1. from Sanskrit _पौत्रः (napAt)_ (grandson) ([[venus|Venus]])
+ [x] **napétile** _noun_ 1. grandson ([[venus|Venus]])
+ [x] **napétine** _noun_ 1. granddaughter ([[venus|Venus]])
+ [ ] **naTa** _adjective_ 1. close (by), near ([[qbri|QBri]])
+ [x] **naTok** _adverb_ 1. nearly, closely, tightly 1. from proposed _naTa_ (close, near) ([[qbri|QBri]])
...
+ [x] **naimre** _noun_ 1. dream ([[venus|Venus]])
+ [x] **naipe** _noun_ 1. wish ([[venus|Venus]])
+ [x] **nairune** _noun_ 2. Nayru 2. sixth month of the Hylian calendar ([[nintendo|Nintendo]], [[venus|Venus]], [[contributors/arrow|Arrow]]?)
+ [x] **naisëte** _noun_ 1. dinner 1. alternate (shorter) form of _naistrisëte_ ([[oluademi-wolfwood|Oluademi Wolfwood]], [[venus|Venus]])
...
+ [x] **ne** _noun, prefix_ 1. feminine object prefix ([[venus|Venus]])
+ [x] **nedag** _verb_ 1. to treat the sick ([[pata-hikari|Pata Hikari]])
+ [x] **nede** _noun_ 1. doctor ([[pata-hikari|Pata Hikari]])
...
+ [x] **none** _noun_ 1. leg ([[k-chan|K-Chan]], [[venus|Venus]])
+ [x] **nonoke** _noun_ 1. legging, leggings ([[k-chan|K-Chan]])
+ [x] **nor** _conjunction_ 1. just, only ([[qbri|QBri]])
+ [ ] **nuSeoke** _noun_ 1. feminine undergarment ([[venus|Venus]])

## Ñ

## O
+ [x] **obJëkte** _noun_ 1. thing, object ([[qbri|QBri]])
+ [x] **okag** _verb_ 1. to wear 1. back-formation from proposed clothing terms ([[k-chan|K-Chan]], [[venus|Venus]])
+ [x] **ol** _preposition_ 1. than 1. from Spanish _ol_ ([[qbri|QBri]])
...
+ [ ] **onkvag** _verb_ 1. to drown 1. from canonical _ont_ (on, in) and random _akve_ (water); _akve_ conflicts with canonical _onkve_ -> recorded as _ononkvag_ ([[qbri|QBri]])
+ [x] **opJoke** _noun_ 1. glasses ([[venus|Venus]])
+ [x] **órode** _noun_ 1. mountain 1. from Ancient Greek _όρος_ (mountain); originally proposed as _órod_ ([[bbb|BBB]], [[venus|Venus]])
...
## P
+ [x] **perine** _noun_ 1. soul ([[pata-hikari|Pata Hikari]])
+ [x] **perludre** _noun_ 1. Fireday 1. second day of the Hylian week; from proposed _perlune_ (elemental fire) and canonical _tiudre_ (daytime) ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[kasuto|Kasuto]], [[contributors/arrow|Arrow]]?)
+ [x] **perlune** _noun_ 1. elemental fire ([[pata-hikari|Pata Hikari]])
+ [x] **perlúnpita** _adjective_ 1. southwest 1. see _perlúnpite_ ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[contributors/auric_trinity|Auric Trinity]])
+ [x] **perlúnpite** _noun_ 1. southwest 1. from proposed _perlun + pite_ "fire gate" ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[contributors/auric_trinity|Auric Trinity]])
+ [x] **pite** _noun_ 1. gate, passage, direction 1. from _Saint Peter_ who is often said to guard the "Golden Gates" or "Pearly Gates" of heaven in Christian mythology ([[contributors/auric_trinity|Auric Trinity]])
...
+ [x] **poe** _noun_ 1. ghost, poe 1. so named for the [[enemy-list|baddie]] (_[[nintendo|Nintendo]]_; [[k-chan|K-Chan]], [[venus|Venus]])
+ [x] **potëra** _adjective_ 1. strong ([[venus|Venus]])
+ [x] **potëre** _noun_ 1. strength ([[venus|Venus]])
+ [x] **pro** _preposition_ 1. for, on behalf of ([[qbri|QBri]])
+ [ ] **proCo** _pronoun_ 1. why ([[qbri|QBri]])
+ [x] **promag** _verb_ 1. to walk ([[qbri|QBri]])
+ [x] **protoJëk** _conjunction_ 1. because ([[qbri|QBri]])

## R
+ [x] **reakete** _noun_ 1. battle ([[k-chan|K-Chan]])
+ [x] **reaToa** _adjective_ 1. angry ([[k-chan|K-Chan]])
+ [x] **rege** _noun_ 1. king, ruler 1. conflicts with proposed _janie_ (monarch) ([[qbri|QBri]])
+ [x] **rekwag** _verb_ 1. to need 1. from English _require_ ([[qbri|QBri]])
+ [x] **rokèlzisag** _verb_ 1. to light (a candle or something) 1. from proposed _igàmobondozisag_ (to light something important on fire) ([[venus|Venus]], [[emekthian|Emekthian]])
+ [x] **rokèlzise** _noun_ 1. light 1. from proposed _igámobondozisag_ (to light something important on fire) ([[venus|Venus]], [[emekthian|Emekthian]])
+ [x] **rope** _noun_ 1. rope (monster), snake 1. so named for the [[enemy-list|baddie]] (_[[nintendo|Nintendo]]_, [[k-chan|K-Chan]], [[venus|Venus]])

## S
+ [x] **sakse** _noun_ 1. stone, rock 1. from Latin _saxum_ ([[qbri|QBri]])
...
+ [x] **saika** _adjective_ 1. recent ([[qbri|QBri]])
+ [ ] **se** _noun_ 1. chest, torso 1. back-formation from proposed _soke_ (shirt) ([[k-chan|K-Chan]], [[venus|Venus]])
+ [x] **serise** _noun_ 1. hair 1. most often used in the plural for a mass of hair, _serisën_ ([[venus|Venus]])
+ [x] **sesolag** _verb_ 1. to rain ([[venus|Venus]])
+ [x] **sesole** _noun_ 1. rain (weather) ([[venus|Venus]])
+ [x] **sëk** _conjunction_ 1. but, however ([[qbri|QBri]])
+ [x] **sëntag** _noun_ 1. to feel 1. from Esperanto _senti_ (to feel) ([[qbri|QBri]])
+ [ ] **si** _conjunction_ 1. if 1. _presumed_ from Spanish _si_ (if), conflicts with canonical _at_ (if) ([[contributors/tushen|Tushen]])
+ [x] **sia** _adjective_ 1. blue 1. from canonical _siafire_ (sapphire) ([[kasuto|Kasuto]], [[venus|Venus]])
+ [x] **sidre** _noun_ 1. week 1. literally “seven-day” from canonical _site tiudre_ (seven day) \[should it be _sitan tiudrën_, though?] ([[kasuto|Kasuto]], [[venus|Venus]], [[contributors/arrow|Arrow]]?)
+ [x] **sihia** _adjective_ 1. green 1. literally “blue-yellow” ([[k-chan|K-Chan]], [[venus|Venus]])
+ [ ] **sihiafire** _noun_ 1. emerald 1. from proposed _sihia_ (green) and canonical _siafire_ (sapphire) ([[contributors/stella_snile]])
+ [x] **silfane** _noun_ 1. elemental wind ([[pata-hikari|Pata Hikari]])
+ [x] **silfánpita** _adjective_ 1. north 1. see _silfánpite_ ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[contributors/auric_trinity|Auric Trinity]])
+ [x] **silfánpite** _noun_ 1. north 1. from proposed _silfane + pite_ "wind gate" ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[contributors/auric_trinity|Auric Trinity]])
+ [x] **simia** _adjective_ 1. purple, violet 1. literally “blue-red” ([[k-chan|K-Chan]], [[venus|Venus]])
+ [ ] **simiafire** _noun_ 1. amethyst 1. from proposed _simia_ (purple) and canonical _siafire_ (sapphire) ([[contributors/stella_snile]])
+ [x] **sipe** _noun_ 1. sibling 1. from Old German _sippa_ (kinship) ([[venus|Venus]])
+ [x] **sípile** _noun_ 1. brother 1. see _sipe_ ([[venus|Venus]])
+ [x] **sípine** _noun_ 1. sister 1. see _sipe_ ([[venus|Venus]])
+ [ ] **skolire** _noun_ 1. shield 1. from Ancient Language (Eragon) _skolir_ (shield) ([[contributors/auric_trinity|Auric Trinity]])
+ [x] **sobre** _noun_ 1. nibling, nephew or niece 1. from Spanish _sobrino, sobrina_ (nephew, niece) ([[venus|Venus]])
+ [x] **sóbrile** _noun_ 1. nephew 1. see _sobre_ ([[venus|Venus]])
+ [x] **sóbrine** _noun_ 1. niece 1. see _sobre_ ([[venus|Venus]])
+ [x] **sofe** _noun_ 1. grandparent 1. from Japanese <em><ruby>祖父<rt>そふ</rt></ruby></em> (grandfather) ([[venus|Venus]])
+ [x] **sófile** _noun_ 1. grandfather ([[venus|Venus]])
+ [x] **sófine** _noun_ 1. grandmother ([[venus|Venus]])
+ [x] **soke** _noun_ 1. shirt ([[k-chan|K-Chan]])
+ [x] **solandre** _noun_ 1. Lightsday 1. sixth day of the Hylian week; from proposed _solane_ (light) and canonical _tiudre_ (daytime) ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[kasuto|Kasuto]], [[contributors/arrow|Arrow]]?)
+ [x] **solane** _noun_ 1. elemental light ([[pata-hikari|Pata Hikari]])
+ [x] **solánpita** _adjective_ 1. eastern 1. see _solánpite_ ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[contributors/auric_trinity|Auric Trinity]])
+ [x] **solánpite** _noun_ 1. east 1. from proposed _solane + pite_ "light gate," referring to the direction of the sunrise ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[contributors/auric_trinity|Auric Trinity]])
+ [x] **soanag** _verb_ 1. to include ([[qbri|QBri]])
+ [x] **stale** _noun_ 1. skeleton (_[[nintendo|Nintendo]]_, [[bbb|BBB]])
+ [x] **striukag** _noun_ 1. to hit, to strike ([[venus|Venus]], [[contributors/arrow|Arrow]]?)
+ [ ] **striukage** _noun_ 1. hit, strike ([[venus|Venus]], [[contributors/arrow|Arrow]]?)

## SH
+ [x] **SëmopJoke** _noun_ 1. sunglasses ([[venus|Venus]])
+ [x] **Síjanag** _noun_ 1. to miss, to feel or be separated from ([[venus|Venus]], [[contributors/arrow|Arrow]]?)
+ [x] **Sonag** _verb_ 1. to jump ([[qbri|QBri]])
+ [x] **Sonage** _noun_ 1. jump, leap 1. from proposed _Sonag_ (to jump) ([[venus|Venus]], [[contributors/arrow|Arrow]]?)
+ [x] **Soyanne** _noun_ 1. explosive, _bomb_ ([[Emekthian]])

## T
+ [x] **tag** _verb_ 1. to take ([[qbri|QBri]])
+ [x] **tálege** _noun_ 1. list ([[qbri|QBri]])
+ [x] **tasag** _verb_ 1. to stand ([[qbri|QBri]])
+ [x] **tektaite** _noun_ 1. tektite (_[[nintendo|Nintendo]]_, [[bbb|BBB]])
+ [x] **terie** _noun_ 1. teri 1. a unit of length equal to 11 _letën_, or 693 U.S. Customary yards (2079 feet) ([[pata-hikari|Pata Hikari]])
+ [x] **tënag** _verb_ 1. to hold 1. from Spanish _tener_ (to hold) ([[qbri|QBri]])
...
+ [x] **tïpag** _verb_ 1. to add ([[qbri|QBri]])
+ [x] **tisëte** _noun_ 1. lunch 1. alternate (shorter) form of _tiudrisëte_ ([[oluademi-wolfwood|Oluademi Wolfwood]], [[venus|Venus]])
...
+ [x] **to’a** _adjective_ 1. some ([[qbri|QBri]])
...
+ [x] **tode** _noun_ 1. dot 1. from English _dot_ ([[qbri|QBri]])
+ [x] **to’e** _noun_ 1. some portion ([[qbri|QBri]])
...
+ [x] **torime daia sidre** _noun, phrase_ 1. end of week ([[kasuto|Kasuto]], [[venus|Venus]], [[contributors/arrow|Arrow]]?)
...
+ [x] **trèowag** _verb_ 1. to trust ([[venus|Venus]])
+ [x] **trèowe** _noun_ 1. trust ([[venus|Venus]])
+ [x] **tro’amiCe** _noun_ 1. second (unit of time) 1. roughly means “(the) third division” with third referring to place or scale; from canonical _tro’a_ (three), originally proposed as _troamiche_ ([[venus|Venus]], [[kasuto|Kasuto]], [[contributors/arrow|Arrow]])
+ [x] **trofaSe** _noun_ 2. Triforce 2. first month of the Hylian year ([[kasuto|Kasuto]], [[venus|Venus]], [[contributors/arrow|Arrow]]?)
+ [x] **trok** _adverb_ 1. so much, too much 1. from Esperanto _tro_ (too much, so much) ([[qbri|QBri]])
+ [x] **trovag** _verb_ 1. to find 1. from Esperanto _trovi_ (to find) ([[qbri|QBri]])
+ [x] **tuka** _adjective_ 1. tired ([[qbri|QBri]])
+ [x] **tukag** _verb_ 1. to tire, to become tired ([[qbri|QBri]])

## TH
+ [x] **Tentag** _verb_ 1. to die 1. see _Tente_ ([[pata-hikari|Pata Hikari]], [[venus|Venus]])
+ [x] **Tente** _noun_ 1. death 1. from Greek _θάνατος_ (death) ([[pata-hikari|Pata Hikari]])

## U
+ [x] **unie** _noun_ 2. Unification 2. fifth month of the Hylian calendar ([[kasuto|Kasuto]], [[venus|Venus]], [[contributors/arrow|Arrow]]?)
+ [x] **upag** _verb_ 1. to pray ([[qbri|QBri]])
+ [x] **uSe** _noun_ 1. crotch, loins, genital region 1. back-formation from _uSeoke_ (undergarment) ([[venus|Venus]])
...
+ [x] **uSeoke** _noun_ 1. undergarment ([[k-chan|K-Chan]])
+ [x] **uSeokile** _noun_ 1. masculine undergarment 1. alternative to _luSeoke_ ([[venus|Venus]])
+ [x] **uSeokine** _noun_ 1. feminine undergarment 1. alternative to _nuSeoke_ ([[venus|Venus]])
+ [x] **uSike** _noun_ 2. Imprisoning, Sealing 2. Eighth month of the Hylian calendar; originally proposed as _ushike_ ([[kasuto|Kasuto]], [[venus|Venus]], [[contributors/arrow|Arrow]]?)
...
+ [x] **uz** _preposition_ 1. like 1. from Czech _uz_ (like, as), similar usage to Spanish _como_ or Esperanto _kiel_ ([[qbri|QBri]])
...
## V
+ [x] **vaitike** _noun_ 1. travel, trip ([[venus|Venus]], [[contributors/arrow|Arrow]]?)
...
+ [ ] **viafire** _noun_ 1. diamond 1. from proposed _via \[2]_ (white, clear) and canonical _siafire_ (sapphire) ([[contributors/stella_snile]])
+ [x] **vokag** _verb_ 1. to call 1. from Epseranto _voki_ (to call) ([[qbri|QBri]])
...
+ [x] **votoere** _noun_ 2. Sacred Realm, Golden Land 2. ninth and final month of the Hylian calendar ([[venus|Venus]], [[contributors/arrow|Arrow]])
...
## Z
+ [x] **zanasune** _noun_ 1. tonight 1. from canonical _za + nasune_ (this night) ([[qbri|QBri]])
+ [x] **zatiudre** _noun_ 1. today 1. from canonical _za + tiudre_ (this day) ([[qbri|QBri]])
+ [x] **zavokag** _verb_ 1. to know, to understand 1. from French _savoir_ (to know) and Japanese _分かる (wakaru)_ (to know) ([[venus|Venus]])
+ [x] **zebrakumag** _verb_ 1. to eclipse, to block light or visibility 1. from English, adult comedian Lewis Black joking about how sunblock cream could be "zebra (semen)" ([[contributors/auric_trinity|Auric Trinity]], Lewis Black)
+ [ ] **zeldne** _noun_ 1. wisdom 1. the root word for the Hylian name Zelda ([[pata-hikari|Pata Hikari]])
+ [x] **zenre** _noun_ 1. animal ([[pata-hikari|Pata Hikari]])
+ [x] **zwa** _adjective, suffix_ 1. more, most 1. used as both a comparative and superlative, follows the adjective suffix as in _nasúnazwa_ (darker, darkest) ([[emekthian|Emekthian]])
...
+ [x] **\*gladius** _ungrammatical_ 1. sword 1. from Latin _gladius_ ([[solowolf|SoloWolf]])
+ [ ] **\*patrus** _ungrammatical_ 1. father 1. from Latin _patrus_ ([[solowolf|SoloWolf]])
+ [x] **\*polutus** _ungrammatical_ 1. chicken, cucco 1. from Latin _polute_ ([[solowolf|SoloWolf]])
