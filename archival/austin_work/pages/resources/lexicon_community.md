...
### AI
+ **ai** ai interjection Ah!, Oh!, Aha! (_Venus, Queen of Faeries_)
+ **aikwe** aikwa noun finger (_Venus, Queen of Faeries_)
...
+ **kudge** (kudge) _noun_ 1. layer /while most of Venus' words are added immediately, the /d'g/ combination feels very unlike Hylian, so this word remains apocryphal for now, conditional on further examples/ (_Venus, Queen of Faeries_)
+ **naSe** (nashe) _noun_ 1. name /I counter-propose the term _sone_ "noun" to represent "name", though perhaps _naSe_ can remain in a specific sense?/ (_Venus, Queen of Faeries_)
+ **sronag** (sronag) _verb_ 1. to frown /the /sr/ combination is unwieldy and may not fit Hylian/ (_Venus, Queen of Faeries_)
+ **srone** (srone) _noun_ 1. frown, expression of displeasure /the /sr/ combination is unwieldy and may not fit Hylian/ (_Venus, Queen of Faeries_)
...
+ **Soyanne** (shoyane) _noun_ 1. explosive /possible, but unlikely -- no evidence for _nn_ exists; propose _shoyane_ instead/ (_emekthian_)
+ **aperag** (aperag) _verb_ 1. to appear, to seem to be /a variant form open for reinterpretation, conflicts with Venus' _mejag_ "to look like, to resemble"/ (_QBri_)
+ **aute** (aute) _noun_ 1. automobile, car (_QBri_)
+ **bëu** (bëu) _pronoun_ 1. me originally proposed as mëu; This serves as the first person singular objective; This is excluded from the language definition because of Kasuto's description of pronouns (_QBri_)
...
+ **kono** (kono) _pronoun_ 1. what Used when a statement is open ended, or to allow free response (_QBri_)
...
+ **minumova** (minumova) _adjective_ 1. still, without motion from "minus movement"; considered apocryphal for oddity (_QBri_)
...
+ **Sgote** (shgote) _noun_ 1. job, employment Was retracted in _Suggest New Words!_ after Kasuto's word was mentioned (_QBri_)
+ **subidag** (subidag) _verb_ 1. to raise up, to lift (_QBri_)
+ **tam** (tam) _conjunction_ 1. then, in that case (_QBri_)
+ **tëu** (tëu) _pronoun_ 1. you This serves as the second person singular objective; This is excluded from the language definition because of Kasuto's description of pronouns (_QBri_)
+ **toatokre** (toatokre) _pronoun_ 1. 1. somewhere (_QBri_)
+ **toakrone** (toakrone) _pronoun_ 1. 1. sometimes (_QBri_)
+ **tokatokre** (tokatokre) _pronoun_ 1. 1. everywhere (_QBri_)
+ **tokakrone** (tokakrone) _pronoun_ 1. 1. always (_QBri_)
+ **tokatiudra** (tokatiudra) _adjective_ 1. 1. daily from _toka_ "every, all" and _tiudre_ "day" (_QBri_)
...
+ **vor** (vor) _preposition_ 1. away From Esperanto _vor_ (_QBri_)
+ **yesus** (yesus) _noun, proper_ 1. Jesus While an interesting use of Hylian, I would counter-propose /yeSuto/ following the naming rules on the new HLI; relegated to Apocrypha for religious content (_QBri_)
...
+ **alvirag** (alvirag) _verb_ 1. Suggested as "to live" Established as _bïnshag_ (_Tushen_)
+ **alvire** (alvire) _noun_ 1. Suggested as "life" Established as _bïnshe_ (_Tushen_)
...
+ **mirag** (mirag) _verb_ 1. Suggested as "to see, to observe" Established as _miarag_ (_Tushen_)
+ **tra** (tra) _adjective_ 1. Suggested as "more" Established as _moka_ (_Tushen_)
+ **trazwa** (trazwa) _adjective_ 1. Suggested as "most" Established as _masa_ (_Tushen_)
+ **volag** (volag) _verb_ 1. Suggested as "to want, to desire" Established as _vo•alag_ (_Tushen_)
+ **bra** (bra) _onomotopoeia_ 1. arf, woof; the sound of a dog speaking (_Pata Hikari_)
+ **lok** (lok) _onomotopoeia_ 1. cluck, caw, chirp; the sound of a cucco (_Pata Hikari_)
+ **acete** (acete) _noun_ 1. c, ts The name of the letter "c" (pronounced /ʦ/) in Hylian (number will be part of final sort) (_Austin_)
+ **añate** (añate) _noun_ 1. ñ, ng The name of the letter "ñ" (pronounced /ŋ/) in Hylian (number will be part of final sort) (_Austin_)
+ **Cate** (chate) _noun_ 1. ch The name of the letter "ch" in Hylian (number will be part of final sort) (_Austin_)
...
+ **neJae** (nejhae) _noun_ 1. grass decomposed from [[contributors/emekthian|emekthian's]] _daminazhëfolkag_ (_Austin_)
...
+ **ûte** (ûte) _noun_ 1. û, oo 1. The name of the letter "û" (pronounced /ɵ/) in Hylian (number will be part of final sort) (_Austin_)
