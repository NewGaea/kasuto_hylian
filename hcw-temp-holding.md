...
+ **adenbag** _verb_ 1. to abandon 1. _presumed_ from English _abandon_ ([[contributors/tushen]])
+ **adenbe** _noun_ 1. abandonment 1. _presumed_ from English _abandon_ ([[contributors/tushen]])
+ **aka** _adjective_ 1. here, this place 1. from spanish _aquí_ (here) ([[qbri|QBri]])
+ **akanto** _unknown class_ 1. now 1. conflicts with canonical _akane_ (now) ([[qbri|QBri]])
+ **akonde** _noun_ 1. sky ([[venus|Venus]])
+ **ala** _adjective_ 1. there, that place ([[qbri|QBri]])
+ **alazae** _noun_ 1. neighbor ([[k-chan|K-Chan]])
+ **albe** _noun_ 2. Holiness 2. seventh month of the Hylian Calendar ([[kasuto|Kasuto]], [[venus|Venus]], [[contributors/arrow]]?)
+ **albende** _noun_ 1. home 1. _presumed_ from Unsourced _alba_ and unknown ([[contributors/tushen]])
+ **albode** _noun_ 1. house 1. from Unsourced _alba_ and English _abode_ ([[contributors/tushen]])
+ **alvirag** _verb_ 1. to live 1. _presumed_ from English _alive_, conflicts with canonical _bïnSag_ ([[contributors/tushen]])
+ **alvire** _noun_ 1. life 1. _presumed_ from English _alive_, conflicts with canonical _bïnSe_ ([[contributors/tushen]])
+ **andre** _noun_ 1. Watersday 1. third day of the Hylian week; from proposed _ane_ (elemental water) and canonical _tiudre_ (daytime) ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[kasuto|Kasuto]], [[contributors/arrow]]?)
...
+ **andakve** _noun_ 1. tear, teardrop 1. from proposed _andwe_ (face) and random _akve_ (water); _akve_ conflicts with canonical _onkve_ (water) ([[qbri|QBri]])
+ **ane** _noun_ 1. elemental water ([[pata-hikari|Pata Hikari]])
+ **anta** _adjective_ 1. ahead of, in front of 1. _presumed_ from Latin _ante_ (before, in front of) ([[qbri|QBri]])
+ **atemptag** _verb_ 1. to reach out 1. from English _attempt_ ([[qbri|QBri]])
+ **avike** _noun_ 1. ocarina ([[k-chan|K-Chan]])

## Ä

## AI
+ **aikwe** _noun_ 1. finger ([[venus|Venus]])

## AU
+ **\*aute** _noun_ 1. car, automobile ([[qbri|QBri]])

## B
+ **batyahe** _noun_ 1. valley 1. originally shared as a noun to play with ([[venus|Venus]])
+ **bërek** _conjunction_ 1. ever 1. “from houd _bebere_ a conjunction meaning _ever_” ([[qbri|QBri]])
...
+ **boka** _adjective_ 1. none ([[qbri|QBri]])
+ **bokakrone** _noun_ 1. never 1. from proposed _boka_ (none) and canonical _krone_ (time) ([[kasuto|Kasuto]], [[qbri|QBri]])
+ **bokatokre** _noun_ 1. nowhere 1. from proposed _boka_ (none) and proposed(?) _tokre_ (place) ([[qbri|QBri]])
+ **boke** _noun_ 1. nothing, no portion ([[qbri|QBri]])
+ **brinstoke** _noun_ 1. sleeve 1. from canonical _brinste_ and proposed _oke_ ([[venus|Venus]])
+ **bünSa** _adjective_ 1. safe ([[qbri|QBri]])
+ **bünSag** _verb_ 1. to be safe ([[qbri|QBri]])

## C

## CH
+ **Cape** _noun_ 1. head 1. back-formation from proposed _chapoke_ (hat) ([[k-chan|K-Chan]], [[venus|Venus]])
+ **Capoke** _noun_ 1. hat ([[venus|Venus]])
+ **Cepaye** _noun_ 1. heart ([[venus|Venus]])
...
+ **deatag** _verb_ 1. to stay, to remain, to reside 1. conflicts with canonical _vïnSag_ ([[qbri|QBri]])
+ **dega** _adjective_ 1. sacred, divine ([[qbri|QBri]])
+ **dégidre** _noun_ 1. Godsday, Goddessday 1. seventh and last day of the Hylian week; from canonical _dege_ (deity, god) and _tiudre_ (daytime) ([[venus|Venus]], [[kasuto|Kasuto]], [[contributors/arrow]]?)
...
+ **dine** _noun_ 2. Din 2. fourth month of the Hylian year ([[nintendo|Nintendo]], [[venus|Venus]], [[contributors/arrow]]?)
+ **disamiCe** _noun_ 1. minute 1. roughly means “(the) second division” with second referring to the place or scale; from canonical _disan_ (two), originally proposed as _disamiche_ ([[venus|Venus]], [[kasuto|Kasuto]], [[contributors/arrow]])
+ **diskelag** _verb_ 1. to descend ([[qbri|QBri]])
+ **dormag** _verb_ 1. to sleep ([[qbri|QBri]])
...
+ **ëd** _conjunction_ 1. or ([[qbri|QBri]])
+ **èdike** _noun_ 1. spring (season) 1. literally means “tree time” from proposed _ëde + ike_ (tree era) ([[venus|Venus]], [[qbri|QBri]], [[contributors/arrow]]?)
+ **ëstatok** _adverb_ 1. suddenly 1. from English _instant_ ([[qbri|QBri]])

## F
+ **faeurike** _noun_ 1. summer 1. literally means “hot time” from proposed _faeura + ike_ (hot era) ([[venus|Venus]], [[kasuto|Kasuto]], [[contributors/arrow]]?)
+ **faeura** _adjective_ 1. hot 1. adjective based on canonical _faeuire_ (fire), originally proposed as _faeura_ \[sic] ([[kasuto|Kasuto]], [[venus|Venus]], [[contributors/arrow]]?)
+ **faróreske** _noun_ 1. Farore 1. second month of the Hylian year ([[nintendo|Nintendo]], [[venus|Venus]], [[contributors/arrow]]?)
+ **fermag** _verb_ 1. to stop, to pause ([[venus|Venus]], [[contributors/arrow]]?)
+ **fermage** _verb_ 1. a stop, a pause 1. nominalized infinitive ending; _possibly_ related to Italian _fermata_? ([[venus|Venus]], [[contributors/arrow]]?)
...
+ **gia** _adjective_ 1. unglossed 1. “going with _-ia_ color adjectives” ([[qbri|QBri]])
...
+ **hedag** _verb_ 1. to make, to create 1. conflicts with canonical _kriaSag_ (to make, to create) ([[contributors/tushen]])
...
+ **hevondre** _noun_ 1. Spiritsday 1. fifth day of the Hylian week; from proposed _hevone_ (spirit) and canonical _tiudre_ (daytime) ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[kasuto|Kasuto]], [[contributors/arrow]]?)
...
+ **hiramiCe** _noun_ 1. hour 1. roughly means “(the) first division“ with first meaning greatest or largest; from canonical _hira_ (one), originally proposed as _hiramiche_ ([[venus|Venus]], [[kasuto|Kasuto]], [[contributors/arrow]])
...
+ **ike** _noun, suffix?_ 1. era, period of time 1. used as a suffix in several proposed words referring to seasons, possibly including _kraitike_ (season), though this may merely be a suffix form of _kraitike_ ([[venus|Venus]], [[contributors/arrow]]?)
+ **ilidane** _noun_ 1. storm ([[slacker|Slacker]])
+ **impelag** _verb_ 1. to force one to perform an action 1. _presumed_ from English _impel_ ([[contributors/tushen]])
...
+ **ire** _noun_ 1. temperature ([[venus|Venus]], [[contributors/arrow]]?)
...
+ **kariuse** _noun_ 1. lightning ([[venus|Venus]], [[contributors/arrow]]?)
+ **karüse** _noun_ 1. electricity, lightning? ([[venus|Venus]], [[contributors/arrow]]?)
+ **katene** _noun_ 1. sword, broadsword 1. from Japanese (_<ruby>刀<rt>かたな</rt></ruby>_) (sword) ([[pata-hikari|Pata Hikari]])
+ **katene lasta** _proper noun_ 1. Master Sword (_[[nintendo|Nintendo]]_, [[pata-hikari|Pata Hikari]])
+ **kaista** _adjective_ 1. cold ([[venus|Venus]], [[contributors/arrow]]?)
+ **kaistike** _noun_ 1. winter 1. literally means “cold time” from proposed _kaista + ike_ (cold era) ([[venus|Venus]], [[contributors/arrow]]?)
+ **kaistire** _noun_ 1. ice 1. compound of proposed _kaista + ire_ (cold temperature), or a mirroring of the structure of canonical _faeuire_ (fire) onto _kaista_ ([[venus|Venus]], [[contributors/arrow]]?)
...
+ **kok** _adverb_ 1. no, not 1. conflicts with canonical _naz_ ([[contributors/tushen]])
+ **koi'ag** _verb_ 1. to open ([[qbri|QBri]])
+ **kraktag** _verb_ 1. to break 1. from English _crack_ ([[qbri|QBri]])
+ **kraitike** _noun_ 1. season ([[venus|Venus]], [[contributors/arrow]]?)
...
+ **ludre** _noun_ 1. Shadowsday 1. fourth day of the Hylian week; from proposed _lune_ (shadow) and canonical _tiudre_ (daytime) ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[kasuto|Kasuto]], [[contributors/arrow]]?)
...
+ **malbage** _noun_ 1. evil (conceptual) 1. _presumed_ from Latine _malus_ (evil), conflicts with proposed _këume_ (trouble, evil) ([[contributors/tushen]])
+ **malborge** _noun_ 1. sickness, illness 1. _presumed_ from Latin _malus_ (evil) ([[contributors/tushen]])
...
+ **mamaonkve** _noun_ 1. Great Flood 1. third month of the Hylian year, from proposed _ma_ (big), reduplicated, and canonical _onkve_ (water) ([[kasuto|Kasuto]], [[venus|Venus]], [[contributors/arrow]]?)
...
+ **mirag** _verb_ 1. to see 1. _presumed_ from Spanish _mire\*_ or Japanese _<ruby>見<rt>み</rt>る</ruby>_ (to look), conflicts with canonical _miarag_ (to look, to see) ([[contributors/tushen]])
...
+ **molordre** _noun_ 1. Forestday 1. first day of the Hylian week; from proposed _molorne_ (forest element) and canonical _tiudre_ (daytime) ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[kasuto|Kasuto]], [[contributors/arrow]]?)
...
+ **nairune** _noun_ 2. Nayru 2. sixth month of the Hylian calendar ([[nintendo|Nintendo]], [[venus|Venus]], [[contributors/arrow]]?)
...
+ **perludre** _noun_ 1. Fireday 1. second day of the Hylian week; from proposed _perlune_ (elemental fire) and canonical _tiudre_ (daytime) ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[kasuto|Kasuto]], [[contributors/arrow]]?)
...
+ **si** _conjunction_ 1. if 1. _presumed_ from Spanish _si_ (if), conflicts with canonical _at_ (if) ([[contributors/tushen]])
+ **sia** _adjective_ 1. blue 1. from canonical _siafire_ (sapphire) ([[kasuto|Kasuto]], [[venus|Venus]])
+ **sidre** _noun_ 1. week 1. literally “seven-day” from canonical _site tiudre_ (seven day) \[should it be _sitan tiudrën_, though?] ([[kasuto|Kasuto]], [[venus|Venus]], [[contributors/arrow]]?)
...
+ **solandre** _noun_ 1. Lightsday 1. sixth day of the Hylian week; from proposed _solane_ (light) and canonical _tiudre_ (daytime) ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[kasuto|Kasuto]], [[contributors/arrow]]?)
+ **soanag** _verb_ 1. to include ([[qbri|QBri]])
+ **stale** _noun_ 1. skeleton (_[[nintendo|Nintendo]]_, [[bbb|BBB]])
+ **striukag** _noun_ 1. to hit, to strike ([[venus|Venus]], [[contributors/arrow]]?)
+ **striukage** _noun_ 1. hit, strike ([[venus|Venus]], [[contributors/arrow]]?)

## SH
+ **SëmopJoke** _noun_ 1. sunglasses ([[venus|Venus]])
+ **Síjanag** _noun_ 1. to miss, to feel or be separated from ([[venus|Venus]], [[contributors/arrow]]?)
+ **Sonag** _verb_ 1. to jump ([[qbri|QBri]])
+ **Sonage** _noun_ 1. jump, leap 1. from proposed _Sonag_ (to jump) ([[venus|Venus]], [[contributors/arrow]]?)
...
+ **torime daia sidre** _noun, phrase_ 1. end of week ([[kasuto|Kasuto]], [[venus|Venus]], [[contributors/arrow]]?)
+ **tra** _adjective_ 1. much, many 1. _presumed_ from French _très_ (much, many), conflicts with canonical _moka_ (much, many) ([[contributors/tushen]])
+ **trazwa** _adjective_ 1. very much, very many 1. _presumed_ from French _très_ (much, many) and proposed _zwa_ (more, most), conflicts with canonical _moka_ (much, many) ([[contributors/tushen]])
+ **trèowag** _verb_ 1. to trust ([[venus|Venus]])
+ **trèowe** _noun_ 1. trust ([[venus|Venus]])
+ **tro’amiCe** _noun_ 1. second (unit of time) 1. roughly means “(the) third division” with third referring to place or scale; from canonical _tro’a_ (three), originally proposed as _troamiche_ ([[venus|Venus]], [[kasuto|Kasuto]], [[contributors/arrow]])
+ **trofaSe** _noun_ 2. Triforce 2. first month of the Hylian year ([[kasuto|Kasuto]], [[venus|Venus]], [[contributors/arrow]]?)
...
## U
+ **unie** _noun_ 2. Unification 2. fifth month of the Hylian calendar ([[kasuto|Kasuto]], [[venus|Venus]], [[contributors/arrow]]?)
...
+ **uSike** _noun_ 2. Imprisoning, Sealing 2. Eighth month of the Hylian calendar; originally proposed as _ushike_ ([[kasuto|Kasuto]], [[venus|Venus]], [[contributors/arrow]]?)
...
## V
+ **vaitike** _noun_ 1. travel, trip ([[venus|Venus]], [[contributors/arrow]]?)
...
+ **volag** _verb_ 1. to want 1. _presumed_ from Latin _volo_ (to want), conflicts with canonical _voalag_ (to want) ([[contributors/tushen]])
+ **vor** _unknown class_ 1. unknown gloss 1. mentioned by Venus as a proposed word from QBri ([[qbri|QBri]])
+ **votoere** _noun_ 2. Sacred Realm, Golden Land 2. ninth and final month of the Hylian calendar ([[venus|Venus]], [[contributors/arrow]])
...
+ **haita** _adjective_ 1. UNGLOSSED 1. open to be played with as of this point ([[venus|Venus]], [[contributors/arrow]]?)
+ **kalda** _adjective_ 1. UNGLOSSED 1. open to be played with at this point ([[venus|Venus]], [[contributors/arrow]]?)
...
+ **dënlete** _noun_ 1. dënleto, small leto 2. a unit of length equal to 9 _matrën_, or 27 U.S. Customary inches ([[pata-hikari|Pata Hikari]])
...
+ **malete** _noun_ 1. maleto, mile 2. a unit of length equal to 3 _terën_, or 1.18125 U.S. Customary miles; _added:_ the _malete_ is the standard measure of traveling distance in Hyrule
+ **banSag** _verb_ 1. to scream, to shriek 1. from English _banshee_ ([[contributors/auric_trinity|Auric Trinity]])
...
+ **ánpite** _noun_ 1. northeast 1. from proposed _ane + pite_ "water gate" ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[contributors/auric_trinity|Auric Trinity]])
...
+ **galénpite** _noun_ 1. south 1. from proposed _galene + pite_ "earth gate" ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[contributors/auric_trinity|Auric Trinity]])
...
+ **ánpita** _adjective_ 1. northeast 1. see _ánpite_ ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[contributors/auric_trinity|Auric Trinity]])
...
+ **galénpita** _adjective_ 1. south 1. see _galénpite_ ([[venus|Venus]], [[pata-hikari|Pata Hikari]], [[contributors/auric_trinity|Auric Trinity]])
...
+ **andwoke** _noun_ 1. mask 1. from proposed _andwe + oke_ (face clothing) ([[contributors/auric_trinity|Auric Trinity]], [[venus|Venus]], [[k-chan|K-Chan]])
...
+ **ësterag** _verb_ 1. to insult 1. from Latin _æstus_ (heat) as used in the lyrics of _Final Fantasy VII's One-Winged Angel_ (_æstuans interius_ "burning inside"), and heard by **Auric** as "esterans" ([[contributors/auric_trinity|Auric Trinity]])
...
+ **animade** _noun_ 1. pain 2. oblivion 1. from Latin _anima_ (spirit, soul) via the aeoun _Anima_ from _Final Fantasy X_; sense retracted after **Venus** noted proposed _ite_ (pain) already exists 2. from one of the moves used by the aeon _Anima_ in Final Fantasy X ([[auric_trinity|Auric Trinity]])
