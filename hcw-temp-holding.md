...
+ **uSeokile** _noun_ 1. masculine undergarment 1. alernative to _luSeoke_ ([[venus|Venus]])
...
+ **obJekte** _noun_ 1. thing, object ([[qbri|QBri]])
...
+ **dega** _adjective_ 1. sacred, divine
...
+ **toatokre** _noun_ 1. somewhere 1. from proposed _toa_ (some) and proposed(?) _tokre_ (place) ([[qbri|QBri]])
...
+ **toakrone** _noun_ 1. sometimes 1. from proposed _toa_ (some) and canonical _krone_ (time) ([[kasuto|Kasuto]], [[qbri|QBri]])
+ **bokakrone** _noun_ 1. never 1. from proposed _boka_ (none) and canonical _krone_ (time) ([[kasuto|Kasuto]], [[qbri|QBri]])
+ **shonag** _verb_ 1. to jump ([[qbri|QBri]])
...
+ **rege** _noun_ 1. king, ruler 1. conflicts with proposed _majie_ (monarch) ([[qbri|QBri]])
+ **kafulag** _verb_ 1. to defeat, to beat ([[qbri|QBri]])
+ **ablat** _preposition_ 1. by, by way of ([[qbri|QBri]])
...
That's a good time to take a break! While it may feel odd to stop in the middle of a post, QBri added a compiled list here!

After sorting the words present, review that all of the words between "**### sort**" and "**### /sort**" on QBri's post are all in the upper lists! Once that's done, you can pick up at "add - **tïpag**" 