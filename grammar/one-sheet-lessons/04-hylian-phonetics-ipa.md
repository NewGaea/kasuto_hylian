...
Most of the consonants in Hylian are pronounced nearly as an American English speaker might expect. The letters \<p>, \<t>, and \<k> are aspirated under the same conditions they are in English.

| **Hylian**<br>**Roman** |                  **English**<br>**Sound**                   | **IPA**<br>**Symbol** |
| :---------------------: | :---------------------------------------------------------: | :-------------------: |
|            b            |                   b as in _bad, tableau_                    | b                     |
|            c            |                  ts as in _cats, tsunami_                   | t͜s                   |
|           ch            |                  ch as in _cheese_, _inch_                  | t͜ʃ                   |
|            d            |                   d as is _door_, _glad_                    | d                     |
|           dh            |                  th as in _then_, _bathe_                   | ð                     |
|            f            |                   f as in _faith_, _safe_                   | f                     |
|            g            |                    g as in _goat_, _bag_                    | g                     |
|            h            |                   h as in _hug_, _Hyrule_                   | h                     |
|            j            |               j as in _jam_<br>g as in _sage_               | d͜ʒ                   |
|            k            |                   k as in _king_, _take_                    | kʰ, k                 |
|            l            |                   l as in _Link_, _mill_                    | l                     |
|            m            |                  m as in _maiden_, _same_                   | m                     |
|            n            |                   n as in _name_, _pain_                    | n                     |
|            ñ            |                       ng as in _king_                       | ŋ                     |
|            p            |                    p as in _pal_, _clap_                    | pʰ, p                 |
...
|            w            |                       w as in _well_                        | w                     |
|            x            |           ch as in _blech_<br> as Scottish _loch_           | x                     |
|            y            |                      y as in _yellow_                       | j                     |
|            z            |                   z as in _Zelda_, _maze_                   | z                     |
|           zh            |         s as in _measure_<br>as French \<j> in _je_         | ʒ                     |
|         ‘ or •          |                  - as in _uh-oh_, _nuh-uh_                  | ʔ                     |
...
Hylian has 11 plain vowels. It is important to understand that all of these are _short, pure vowels_: They do not have the offglide that many English vowels do, and are closer to Spanish or Japanese vowels.

| **Hylian**<br>**Roman** |                   **Sound**                    | **IPA**<br><br>**Symbol** |
| :---------------------: | :--------------------------------------------: | :-----------------------: |
|        **a, á**         |           a as in Sp. _m**a**m**a**_           |           **a**           |
|        **e, é**         |            e as in Sp. _s**e**ñor_             |           **e**           |
|        **i, í**         |             i as in Sp. _p**i**na_             |           **i**           |
|        **o, ó**         |             o as in Sp. _r**o**sa_             |           **o**           |
...
Also, it may be difficult to hear the difference between \<a, á> and \<ö, ò> if you speak a dialect affect by the [**cot-caught merger**](https://en.wikipedia.org/wiki/Cot–caught_merger), or the [**father-bother merger**](https://en.wikipedia.org/wiki/Phonological_history_of_English_open_back_vowels#Father–bother_merger).
